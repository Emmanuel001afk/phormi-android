...
class HelpActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        section(body, "Downloads & files", "Normal downloads use Phormi's resumable in-app transfer engine while legacy Android DownloadManager items are still shown in the list. Supported media can open in Phormi's viewer; other files can be handed to an installed Android application. Download handling preserves the page's user agent, referrer and available cookies when appropriate.")
