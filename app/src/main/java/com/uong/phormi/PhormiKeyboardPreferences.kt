...
object PhormiKeyboardPreferences {
    ...
    private const val SUGGESTIONS="suggestions";private const val AUTOCORRECT="autocorrect";private const val AUTO_CAPS="auto_caps";private const val HAPTIC="haptic";private const val SOUND="sound"
